...
cd = qalpha(k)*sqrt(k*(k+1)/(6*N)) % - 1.215
...
for i=1:ceil(k/2)
   ...
   h = text(1.25, 100 - 5*(n+1)- 10*i + 3.5, a, 'FontSize', 11, 'HorizontalAlignment', 'right');

   text(1.3, 100 - 5*(n+1) - 10*i, labels{idx(i)}, 'FontSize', 12, 'VerticalAlignment', 'middle', 'HorizontalAlignment', 'left');
...
for i=ceil(k/2)+1:k
   ...
   text(-0.25, 100 - 5*(n+1) -10*(k-i+1)+3.5, a, 'FontSize', 11, 'HorizontalAlignment', 'left');

   text(-0.3, 100 - 5*(n+1) -10*(k-i+1), labels{idx(i)}, 'FontSize', 12, 'VerticalAlignment', 'middle', 'HorizontalAlignment', 'right');
